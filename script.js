...
function showCurrentLink() {
  ...
  titleElement.textContent = currentLink.title;
  descriptionElement.textContent = currentLink.description;
}
...
function prevLink() {
  ...
  showCurrentLink();
  if (isPaused) startRotation(); // Reinicia temporariamente para mostrar o link
}
